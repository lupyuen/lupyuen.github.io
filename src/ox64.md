...
Bouffalo Lab BL808 SoC is a curiously complex creature with 3 (Asymmetric) RISC-V Cores (linked via IPC, pic below)...
...
1.  __D0 Core:__ [__64-bit T-Head C906__](https://www.t-head.cn/product/c906?lang=en) (RV64IMAFCV, 480 MHz)
    ...
    __Memory Management Unit__ is Sv39 with 128 / 256 / 512 TLB table entry. (Like Star64?)
...
[Pine64 Ox64](https://wiki.pine64.org/wiki/Ox64) is the dev board for BL808C. (Pic below)

BL808C supports MIPI CSI Cameras but not MIPI DSI Displays.
...
We tested with the [__Pine64 Woodpecker CH340G__](https://pine64.com/product/serial-console-woodpecker-edition/) USB Serial Adapter on macOS x64.

We are connecting at 2 Mbps, which might be too fast for some USB Serial Adapters. (Like this [__CP2102 Dongle__](https://www.lazada.sg/products/i2037772272-s11135131253.html), which shows garbled text at 2 Mbps)
...
1.  To Test our USB Serial Adapter: Connect the USB Serial Adapter to __Ox64 Flashing UART__ (pic above)...
    ...
    Start the USB Serial Terminal (for Flashing UART) at 2,000,000 bps (2 Mbps).
...
* [__d0_lowload__](https://github.com/openbouffalo/OBLFR/tree/master/apps/d0_lowload)
: This is a very basic bootloader that loads opensbi, the kernel and dts files into ram
...
1.  Download Bouffalo Lab DevCube 1.8.3 from...
    ...
    ![TODO](https://lupyuen.github.io/images/ox64-flash1.png)

1.  Run DevCube, select "BL808", and switch to "MCU" page

    ![TODO](https://lupyuen.github.io/images/ox64-flash2.jpg)
...
1.  Click "Create & Download" and wait until it's done
    ...
    ![TODO](https://lupyuen.github.io/images/ox64-flash3.png)

    [(See the log)](https://gist.github.com/lupyuen/125e15be5ed1e034bed33d16ed496d87)

1.  Switch to "IOT" page

    ![TODO](https://lupyuen.github.io/images/ox64-flash4.jpg)
...
1.  Click "Create & Download" again and wait until it's done
    ...
    ![TODO](https://lupyuen.github.io/images/ox64-flash5.png)
