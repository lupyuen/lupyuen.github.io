...
1.  _How to boot Apache NuttX RTOS on Ox64?_
    ...
    - [__"Linux Image Header for Ox64"__](https://lupyuen.codeberg.page/articles/ox64.html#appendix-linux-image-header-for-ox64)
...
1.  _How will we print to the Serial Console?_
    ...
    - [__"Linux Device Tree for Ox64"__](https://lupyuen.codeberg.page/articles/ox64.html#appendix-linux-device-tree-for-ox64)

    Or we'll call __OpenSBI Legacy Console__...

    - [__"Call OpenSBI from NuttX"__](https://lupyuen.github.io/articles/sbi#call-opensbi-from-nuttx)

      [(Ox64 implements __SBI Spec v1.0__)](https://gist.github.com/lupyuen/3035a70d52d2d1d529e96f5292f54210#file-ox64-linux-boot-log-L54)
...
1.  _Will we boot NuttX on both 32-bit and 64-bit RISC-V Cores? (Pic above)_
    ...
    [(__Linux Device Tree__ tells us how)](https://lupyuen.codeberg.page/articles/ox64.html#appendix-linux-device-tree-for-ox64)

    Later we might boot NuttX on the 32-bit M0 Wireless Core. And let the 64-bit and 32-bit Cores talk over [__OpenAMP (Asymmetric Multi-Processing)__](https://www.openampproject.org/).
...
1.  _OpenSBI will boot NuttX on the 32-bit RISC-V Core right?_
    ...
    We'll have to flash 32-bit NuttX to Ox64 with [__BL Dev Cube__](https://lupyuen.codeberg.page/articles/ox64.html#flash-opensbi-and-u-boot-bootloader). (Ouch!)

1.  _Are you sorry that NuttX Fans had to put up with this entire article?_

    Yes I'm truly sorry! But that's exactly how we'll run NuttX on Ox64...
