...
Bouffalo Lab BL808 SoC is a complex creature with 3 (Asymmetric) RISC-V Cores (linked via IPC, pic below)...

1.  __D0 Core:__ [__64-bit T-Head C906__](https://www.t-head.cn/product/c906?lang=en) (RV64IMAFCV, 480 MHz)

    __Multimedia Core__ with MIPI CSI / DSI, Neural Proc Unit

    __Memory Mgmt Unit__ is Sv39, 128 / 256 / 512 TLB table entry. (Like Star64?)

1.  __M0 Core:__ [__32-bit T-Head E907__](https://www.t-head.cn/product/e907?lang=en) (RV32IMAFCP, 320 MHz)

    __Wireless + Peripherals Core__ with WiFi, BLE, BT, Zigbee, Audio
