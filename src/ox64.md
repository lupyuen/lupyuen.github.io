...
Perhaps Ox64 BL808 might run more efficiently with a tiny 64-bit RTOS like Apache NuttX?
...
1.  _How will we boot Apache NuttX RTOS on Ox64?_
    ...
    "Pretending to be Linux" has worked remarkably well for booting NuttX on PinePhone, PinePhone Pro, NanoPi M4 SBC and Star64 RISC-V SBC!
...
1.  _OpenSBI will control the 32-bit RISC-V Core right?_
