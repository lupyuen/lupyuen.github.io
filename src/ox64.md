...
Bouffalo Lab BL808 is a complex creature with 3 (Asymmetric) RISC-V Cores (linked via IPC, pic below)...

1.  __D0 Core:__ [T-Head C906 64-bit RV64IMAFCV](https://www.t-head.cn/product/c906?lang=en) (480 MHz)
...
1.  __M0 Core:__ [T-Head E907 32-bit RV32IMAFCP](https://www.t-head.cn/product/e907?lang=en) (320 MHz)

    (__Wireless + Peripherals Core__ with WiFi, BLE, BT, Zigbee, Audio)

1.  __LP Core:__ [T-Head E902 32-bit RV32E[M]C](https://www.t-head.cn/product/e902?lang=en) (150 MHz)
