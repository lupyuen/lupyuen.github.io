...
- [__m0_lowload__](https://github.com/openbouffalo/OBLFR/tree/master/apps/m0_lowload) for M0 Wireless Core:
  ...
  [(Like __SD Card__ and __GPIO Interrupts__)](https://lupyuen.github.io/articles/ox64#appendix-peripheral-interrupts-for-ox64)
...
1.  _How to boot Apache NuttX RTOS on Ox64?_
    ...
    - [__"Linux Image Header for Ox64"__](https://lupyuen.github.io/articles/ox64#appendix-linux-image-header-for-ox64)
...
1.  _How will we print to the Serial Console?_
    ...
    - [__"Linux Device Tree for Ox64"__](https://lupyuen.github.io/articles/ox64#appendix-linux-device-tree-for-ox64)
...
1.  _Will we boot NuttX on both 32-bit and 64-bit RISC-V Cores? (Pic above)_
    ...
    [(__Linux Device Tree__ tells us how)](https://lupyuen.github.io/articles/ox64#appendix-linux-device-tree-for-ox64)
...
1.  _OpenSBI will boot NuttX on the 32-bit RISC-V Core?_
    ...
    We'll have to flash 32-bit NuttX to Ox64 with [__BL DevCube__](https://lupyuen.github.io/articles/ox64#flash-opensbi-and-u-boot-bootloader). (Ouch!)
