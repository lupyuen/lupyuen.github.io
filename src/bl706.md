...
1.  __AliOS Functions__ (`aos_*`) for multitasking and device management are no longer in BL706 MCU SDK.

1.  __JTAG and J-Link__ are now supported for flashing BL706. 
