...
When the LoRa Message has been transmitted, the SX1262 Library calls our Callback Function __on_tx_done__ defined in [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L267-L280)
...
Let's run our SX1262 Test App to __transmit a LoRa Message__...
...
1.  Also edit [__sx1262_test_main.c__](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L10-L46) and set the __LoRa Parameters__. (As explained earlier)
...
1.  We should see the same 64-byte __LoRa Message__ received by WisBlock...
...
Let's run our SX1262 Test App to __receive a LoRa Message__...
...
1.  WisBlock transmits a 64-byte __LoRa Message__...
...
1.  On NuttX we should see the same 64-byte LoRa Message...
    ...
    Our SX1262 Library has successfully received the 64-byte LoRa Message from RAKwireless WisBlock!
