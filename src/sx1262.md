...
Yep we might have issues keeping our LoRaWAN Stack in sync with Semtech's version.

[(More about this)](https://lupyuen.github.io/articles/sx1262#notes)
...
We'll port this __LoRaWAN Stack__ to NuttX...

-   [__lupyuen/lorawan__](https://github.com/lupyuen/lorawan)

(Which was ported from Apache Mynewt OS to BL602 IoT SDK)
...
1.  How do other Embedded Operating Systems implement LoRaWAN?
    ...
    -   __Mynewt__ embeds a [__Partial Fork__](https://github.com/apache/mynewt-core/tree/master/net/lora/node) of Semtech's LoRaWAN Stack into its source tree.
