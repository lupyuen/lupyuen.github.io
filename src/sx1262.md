...
Let's look at the __Event Loop__ that handles the Events in our Event Queue: [lorawan_test_main.c](https://github.com/lupyuen/lorawan_test/blob/main/lorawan_test_main.c#L611-L655)
...
-   For DIO1 Interrupt Events: [__RadioOnDioIrq__](https://lupyuen.github.io/articles/sx1262#radioondioirq)

-   For Timer Events: The __Timeout Function__ defined in the Timer
...
That's how we handle Events in our Event Queue with NimBLE Porting Layer!
