...
Let's dive into the SPI Interface.
...
Our SX1262 Library opens the SPI Test Driver to __initialise the SPI Bus__ like so: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L663-L675)
...
We're controlling the __SPI Chip Select Pin__ ourselves via GPIO Output, as explained below...
...
[(Source)](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L677-L703)
