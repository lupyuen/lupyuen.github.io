...
Our code has been configured for [__PineDio Stack BL604__](https://lupyuen.github.io/articles/pinedio) and its onboard SX1262 Transceiver.
...
We have configured the following Pin Definitions in [board.h](https://github.com/lupyuen/incubator-nuttx/blob/sx1262/boards/risc-v/bl602/bl602evb/include/board.h#L42-L95)
...
Right now we won't use __BOARD_GPIO_IN1__ (Busy Pin) and __BOARD_GPIO_INT1__ (DIO1).

__For BL602:__ Connect SX1262 to [these pins](https://lupyuen.github.io/articles/spi2#connect-sx1262). Update the Pin Definitions in...

```text
boards/risc-v/bl602/bl602evb/include/board.h
```

According to this: [board.h](https://github.com/lupyuen/incubator-nuttx/blob/spi_test/boards/risc-v/bl602/bl602evb/include/board.h#L48-L49)
...
_What are these pins on SX1262: DIO1, BUSY and NRESET?_
...
We'll learn more about the pins in a while.
...
__sx126x_read_register__ reads a register by sending the Read Register Command to SX1262 over SPI: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L495-L504)
...
Remember to edit [__sx1262_test_main.c__](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c) and uncomment...
...
![Reading SX1262 Registers](https://lupyuen.github.io/images/sx1262-read5.png)
...
TODO: The Source Files __specific to Linux__ are...

-   [__sx1262_test_main.c__](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c)
...
We set the __LoRa Frequency__ like so: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L30-L45)
...
Now we're ready to __transmit a LoRa Message__! Here's how: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L110-L121)
...
When the LoRa Message has been transmitted, the LoRa Driver calls our Callback Function __on_tx_done__ defined in [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L267-L280)
...
Also edit [__sx1262_test_main.c__](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L10-L46) and set the __LoRa Parameters__. (As explained earlier)
...
On [__RAKwireless WisBlock__](https://github.com/lupyuen/wisblock-lora-receiver) we should see the same 64-byte LoRa Message received...
...
This is how we do it: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L107-L137)
...
__receive_message__ is defined like so: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L255-L262)
...
When the LoRa Driver receives a LoRa Message, it calls our Callback Function __on_rx_done__ defined in [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L282-L312)
...
The LoRa Driver calls our Callback Function __on_rx_timeout__ defined in [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L328-L341)
...
To handle Receive Errors, we define the Callback Function __on_rx_error__: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L343-L355)
...
Here's how the SX1262 Library calls our SPI Test Driver to __initialise the SPI Bus__: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L663-L675)
...
TODO: SPI Mode is defined in SPI Test Driver
...
To __transfer SPI Data__ to SX1262 via our SPI Test Driver, we do this: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L677-L703)
...
Our SX1262 Library calls this function to __transmit a LoRa Message__: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L506-L512)
...
__sx126x_hal_write__ transfers the Command Buffer and Data Buffer over SPI: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L544-L581)
...
We use an internal __1024-byte buffer for SPI Transfers__, so we're hunky dory here: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L533-L540)
...
Our SX1262 Library calls this function to __receive a LoRa Message__: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L514-L522)
...
__sx126x_hal_read__ transfers the Command Buffer over SPI: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L583-L627)
...
-   __DIO1__: Because we don't support GPIO Interrupts (yet), we __poll the SX1262 Status every second__ to check if a LoRa Packet has been received.
    ...
    [(See this)](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L126-L136)
...
When we have implemented __GPIO Interrupts__ in our driver, we can remove the [__Event Polling__](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L126-L136). And we run a __Background Thread__ to handle LoRa Events.
...
After we have implemented __GPIO Interrupts__ in our SX1262 Library, this is how we'll __receive LoRa Messages__ (see pic above)...
...
The code below shall be updated to __start the Background Thread__: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L369-L388)
...
[(We don't need to code the Event Queue, it has been done here)](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L357-L432)
