...
In our PineDio USB Driver, __SX126xReadRegister__ calls __SX126xReadRegisters__ and __sx126x_read_register__ to read each register: [sx126x-linux.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-linux.c#L268-L281)
...
Here's how our PineDio USB Driver calls CH341 SPI Driver to __initialise the SPI Bus__: [sx126x-linux.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-linux.c#L651-L667)
...
To __transfer SPI Data__ between PineDio USB and CH341 / SX1262, we do this: [sx126x-linux.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-linux.c#L669-L691)
...
Our PineDio USB Driver calls this function to __transmit a LoRa Message__: [sx126x-linux.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-linux.c#L497-L503)
...
Our PineDio USB Driver calls this function to __receive a LoRa Message__: [sx126x-linux.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-linux.c#L505-L513)
