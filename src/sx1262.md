...
![PineDio Stack BL604 with onboard Semtech SX1262 (left) sniffed wirelessly with Airspy R2 Software Defined Radio (right)](https://lupyuen.github.io/images/sx1262-title.jpg)

_PineDio Stack BL604 with onboard Semtech SX1262 (left) sniffed wirelessly with Airspy R2 Software Defined Radio (right)_
...
Our LoRa SX1262 Driver will work perfectly fine for __Point-to-Point Wireless Communication__.

But if we need to __relay data packets__ to multiple devices or to the internet, we need __LoRaWAN__.
...
Someday we might connect our NuttX gadget to a __LoRaWAN Network__ like...
...
Thus it's good to build a LoRa Driver for NuttX that will support LoRaWAN in future.
...
To receive a LoRa Message, [__sx126x_read_buffer__](https://lupyuen.github.io/articles/usb#receive-long-message) sends this __ReadBuffer Command__ to SX1262 over SPI...
