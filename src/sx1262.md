...
Our LoRa SX1262 Driver will run on Bouffalo Lab's __BL602 and BL604 RISC-V SoCs__. And probably __ESP32__ too, since we're calling standard NuttX Interfaces.
...
Libraries run in app and NuttX OS

Easier to troubleshoot

Drivers run only inside NuttX OS
