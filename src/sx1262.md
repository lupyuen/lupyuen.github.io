...
The code below shall be updated to __start the Background Thread__ by calling the NimBLE Porting Layer: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L369-L388)
