...
Later as we inspect the code that __receives LoRa Messages__, we'll see that our SX1262 Library calls this function when a __Receive Done Event__ is triggered: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L514-L522)
...
__sx126x_hal_read__ calls __transfer_spi__ to transfer the Command Buffer over SPI: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L583-L627)
...
Let's look back at our code in [__sx126x_write_buffer__](https://lupyuen.github.io/articles/sx1262#transmit-message).
...
This appears in the [__Output Log__](https://gist.github.com/lupyuen/5fdede131ad0e327478994872f190668) as...
...
Which appears in the [__Output Log__](https://gist.github.com/lupyuen/0d78b13871fca41ac6d812407890b29b) as...
...
[(TODO: __sx126x_read_buffer__ is explained here)](https://lupyuen.github.io/articles/sx1262#long-messages)
