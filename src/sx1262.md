...
To transmit and receive LoRa Messages without polling we need __Timers, Event Queues and Background Threads__. Which are provided by NimBLE Porting Layer.
...
(Though it's not integrated with our SX1262 Library yet)
...
The code below shall be updated to __start the Background Thread__ by calling NimBLE Porting Layer: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L369-L388)
...
In this section we explain the Platform-Independent __Radio Functions__, which are defined in [radio.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/radio.c)
...
This code is nearly identical to [____Semtech's Reference Implementation____](https://github.com/Lora-net/LoRaMac-node/tree/master/src/radio/sx126x) of SX1262 Driver (29 Mar 2021).

(So it should work perfectly fine with Semtech's LoRaWAN Stack)
...
__RadioRx__ preps SX1262 to receive a single LoRa Message: [radio.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/radio.c#L1117-L1138)
