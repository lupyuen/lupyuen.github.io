...
Yep our SX1262 Library is structured as __layers of Source Files__ because we hope to support 3 platforms...

1.  __NuttX__

1.  [__Linux__](https://lupyuen.github.io/articles/usb) (PineDio USB)

1.  [__BL602 IoT SDK__](https://lupyuen.github.io/articles/lorawan)

The __Platform-Independent__ Source Files shared by all platforms are...

-   [__src/sx126x.c__](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x.c)

    (Semtech Driver for SX1262 Transceiver)

-   [__src/radio.c__](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/radio.c)

    (Semtech Radio Interface for LoRa Transceivers)
...
The __init_driver__ function in our library takes the LoRa Parameters and initialises LoRa SX1262 like so: [sx1262_test_main.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/sx1262/examples/sx1262_test/sx1262_test_main.c#L149-L203)
...
The __Radio__ functions are Platform-Independent, defined in [radio.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/radio.c)
