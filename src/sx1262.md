...
-   __DIO1__ (/dev/gpio2): GPIO Interrupt used by SX1262 to signal that a LoRa Packet has been transmitted or received

    (DIO1 shifts from Low to High when that happens)

-   __BUSY__ (/dev/gpio0): GPIO Input that tells us whether SX1262 is busy
