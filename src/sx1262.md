...
Note that we're using the older __"nuttx"__ branch of the "lora_sx1262" repo, which __doesn't use GPIO Interface and NimBLE Porting Layer__. (And doesn't support LoRaWAN)
...
1.  Download the modified source code...
    ...
    Note that we're using the older __"sx1262"__ branch of the NuttX OS and NuttX Apps repos, which __don't use GPIO Interface and NimBLE Porting Layer__. (And don't support LoRaWAN)
...
-   __DIO1__: Because we don't support GPIO Interrupts (yet), we __poll the SX1262 Status every second__ to check if a LoRa Packet has been received.
    ...
    __UPDATE:__ DIO1 has been implemented with GPIO Interrupt, this section shall be updated shortly
...
-   __BUSY__: Instead of reading this pin to check if SX1262 is busy, we __sleep 10 milliseconds__.
    ...
    __UPDATE:__ BUSY has been implemented with GPIO Input, this section shall be updated shortly
