...
-   __DIO1__ (/dev/gpio2): Used by SX1262 to signal that a LoRa Packet has been transmitted or received

    (DIO1 shifts from Low to High when that happens)

-   __BUSY__ (/dev/gpio0): Tells us whether SX1262 is busy
...
-   [__Lora-net/LoRaMac-node/src/mac__](https://github.com/Lora-net/LoRaMac-node/tree/master/src/mac)

-   [__Follow the updates on Twitter__](https://twitter.com/MisterTechBlog/status/1473593455699841027)
