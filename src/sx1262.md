...
We've talked about [__sx126x_write_buffer__](https://lupyuen.github.io/articles/sx1262#transmit-message) and [__sx126x_read_buffer__](https://lupyuen.github.io/articles/sx1262#receive-message), let's watch them in action as we __transmit and receive__ LoRa Messages.
...
-   __BUSY__: Tells us whether SX1262 is busy

    (__BUSY__ is High when SX1262 is busy)

-   __NRESET__: Toggled to reset the SX1262 module

But the current SX1262 Library __doesn't use these pins yet__.
