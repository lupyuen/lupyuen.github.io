...
__sx126x_hal_write__ calls __transfer_spi__ to transfer the Command Buffer and Data Buffer over SPI: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L544-L581)
...
They are the internal __1024-byte buffers for SPI Transfers__: [sx126x-nuttx.c](https://github.com/lupyuen/lora-sx1262/blob/nuttx/src/sx126x-nuttx.c#L533-L540)
