...
But NuttX Shell won't work until we have implemented UART Input in our __UART Driver__. So we'll do this now...

-   [__"UART Driver"__](https://lupyuen.github.io/articles/uboot#uart-driver)
