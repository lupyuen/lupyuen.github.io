...
From [rust_test/run.sh](https://github.com/lupyuen/rust_test/blob/main/run.sh#L76-L83)
...
From [rust_test/run.sh](https://github.com/lupyuen/rust_test/blob/main/run.sh#L89-L94)
...
From [rust_test/run.sh](https://github.com/lupyuen/rust_test/blob/main/run.sh#L96-L99)
...
From [rust_test/run.sh](https://github.com/lupyuen/rust_test/blob/main/run.sh#L105-L108)
