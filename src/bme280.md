...
![I2C Sub Address](https://lupyuen.github.io/images/bme280-subaddress.png)

[(Source)](https://lupyuen.github.io/articles/i2c#set-i2c-device-address-and-register-address)

TODO

When we browse the NuttX code for BL602's I2C Driver, we realise that it supports __I2C Sub Address__: [bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L719-L738)
...
Let's patch the NuttX BMP280 Driver to send the __Register ID as I2C Sub Address__ (instead of I2C Data) when we're reading a BMP280 Register: [bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L202-L217)
...
And we patch this too: [bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L244-L257)

```c
//  Read multiple BME280 Registers
static int bmp280_getregs(FAR struct bmp280_dev_s *priv, uint8_t regaddr, uint8_t *rxbuffer, uint8_t length) {
  ...
...
_What about writing a BMP280 Register? Do we need to set the I2C Sub Address?_
