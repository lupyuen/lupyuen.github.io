...
Earlier we ran the __Sensor Test App__ to read BME280's Barometer and Humidity Sensors (pic above)...
...
Then we __read and print the Sensor Data__...
...
_But our Sensor Data is Humidity, not Proximity. Why cast to sensor_event_prox instead of sensor_event_humi?_
...
The Sensor Test App reuses the same function __print_valf__ for printing both Humidity and Proximity Sensor Data. Which is OK because both structs have the same size.
