...
_Why don't we create the BME280 Driver based on the datasheet?_

Well yes we could... But then the rest of this article would become an academic exercise 😉

_Why port from Zephyr OS?_

Zephyr has an [__impressive collection__](https://github.com/zephyrproject-rtos/zephyr/tree/main/drivers) of drivers. 

TODO

Might work for other Zephyr drivers with minimal changes!
