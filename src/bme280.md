...
[__UPDATE:__ Yes we need to send the Register ID + Register Value as I2C Sub Address, followed by an I2C Read. See this](https://github.com/lupyuen/rust-i2c-nuttx#fix-i2c-write)
...
[__UPDATE:__ Nope it's not writing correctly. We need to send the Register ID + Register Value as I2C Sub Address, followed by an I2C Read. See this](https://github.com/lupyuen/rust-i2c-nuttx#fix-i2c-write)
