...
(We'll see __g_sensor_info__ in a while)
...
[sensortest.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/bme280/testing/sensortest/sensortest.c#L146-L151)
...
[sensortest.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/bme280/testing/sensortest/sensortest.c#L139-L144)
...
static void print_valf(const char *buffer, const char *name) {
  ...
  //  which is same size as Humidity Sensor Data
...
[sensortest.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/bme280/testing/sensortest/sensortest.c#L77-L110)
