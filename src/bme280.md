...
When we browse the NuttX code for BL602's I2C Driver, we realise that it __supports I2C Sub Address__: [bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L719-L738)
