...
Before we start our exploration, verify that our BME280 Sensor works OK.
...
[(Testing BME280 with Bus Pirate)](https://lupyuen.github.io/articles/i2c#appendix-test-bme280-with-bus-pirate)
...
(UART0 is used by the Serial Console, we'll leave it alone)
