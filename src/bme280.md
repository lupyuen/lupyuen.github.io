...
Let's take a quick look inside the Sensor Test App, so that we understand how to code our own Sensor Apps.

TODO

[sensortest.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/bme280/testing/sensortest/sensortest.c#L233-L401)
