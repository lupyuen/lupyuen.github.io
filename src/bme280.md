...
The I2C Pins on BL602 are defined here: [board.h](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/boards/risc-v/bl602/bl602evb/include/board.h#L85-L88)
...
We disabled the UART1 Port because it uses the same pins as I2C: [board.h](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/boards/risc-v/bl602/bl602evb/include/board.h#L63-L68)
...
[SparkFun BME280 Breakout Board](https://learn.sparkfun.com/tutorials/sparkfun-bme280-breakout-hookup-guide/all)
...
For testing, we change the I2C Address and Device ID for BME280: [bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L45-L57)
...
Register BMP280 Driver at startup: [bl602_bringup.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/boards/risc-v/bl602/bl602evb/src/bl602_bringup.c#L623-L640)
...
BL602 NuttX I2C Driver doesn't log the data transferred ... Let's log ourselves: [bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L194-L197)
...
[bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L207-L216)
...
[bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L740-L742)
...
[(Source)](https://lupyuen.github.io/articles/i2c#set-i2c-device-address-and-register-address)

BL602 NuttX I2C Driver needs us to provide the I2C Sub Address (Register ID): [bl602_i2c.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/arch/risc-v/src/bl602/bl602_i2c.c#L719-L738)
...
Here's how we patch the NuttX BMP280 Driver to send the Register ID as I2C Sub Address (instead of I2C Data): [bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L202-L217)
...
[bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L244-L257)
...
[bmp280.c](https://github.com/lupyuen/incubator-nuttx/blob/bmp280/drivers/sensors/bmp280.c#L286-L300)
...
[testing/sensortest/sensortest.c](https://github.com/lupyuen/incubator-nuttx-apps/blob/bme280/testing/sensortest/sensortest.c)
...
[zephyr/drivers/sensor/bme280/bme280.c](https://github.com/zephyrproject-rtos/zephyr/blob/main/drivers/sensor/bme280/bme280.c)
