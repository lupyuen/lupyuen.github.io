...
| Zephyr Driver | NuttX Driver | Function
| ------------- | -------------| ----------
| bme280_chip_init,<br>bme280_pm_action | [__bme280_register__](https://github.com/lupyuen/bme280-nuttx/blob/main/driver.c#L668-L773) | Register sensor at startup
| bme280_pm_action | [__bme280_activate__](https://github.com/lupyuen/bme280-nuttx/blob/main/driver.c#L397-L431) | Switch to Normal / Low Power Mode
| bme280_sample_fetch,<br>bme280_channel_get | [__bme280_fetch__](https://github.com/lupyuen/bme280-nuttx/blob/main/driver.c#L487-L572) | Fetch sensor values
| _(Static Interval)_ | [__bme280_set_interval__](https://github.com/lupyuen/bme280-nuttx/blob/main/driver.c#L287-L341) | Set standby interval
...
This returns a Zephyr [__sensor_value__](https://docs.zephyrproject.org/latest/reference/peripherals/sensor.html#c.sensor_value) struct that stores the Pressure (kilopascal) as a [__Fixed-Point Number__](https://en.wikipedia.org/wiki/Fixed-point_arithmetic).

We convert the Pressure from __Fixed Point to Float__ (in millibars)...
...
We do the same to get the __Temperature__ (°C) from the fetched sample...
...
Mapping the __Power Management__ functions from Zephyr to NuttX is straightforward: [driver.c](https://github.com/lupyuen/bme280-nuttx/blob/main/driver.c#L397-L431)
...
![Power Management](https://lupyuen.github.io/images/bme280-code10.png)
