...
So we __borrow the output__ from another QuickJS Build (Debian x64)...
...
They contain [__JavaScript Bytecode__](https://github.com/lupyuen/quickjs-nuttx/blob/master/nuttx/repl.c). Brilliant!
