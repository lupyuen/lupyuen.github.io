...
mkdir /mnt/c/blflash
cp build_out/sdk_app_st7789.bin /mnt/c/blflash
```
...
```bash
## For Linux:
blflash flash build_out/sdk_app_st7789.bin \
    --port /dev/ttyUSB0
...
blflash flash c:\blflash\sdk_app_st7789.bin --port COM5
```
...
1.  __UART E-Ink Display:__ Here's a quick detour on __E-Ink Displays with UART Interfaces__...
