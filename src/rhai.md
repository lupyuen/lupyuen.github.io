...
-   __`on_start`__ [(See this)](https://github.com/lupyuen2/blockly-bl602/blob/master/generators/rhai/app_code.js#L3-L12)
...
Here's how we define the __`forever` Code Generator__: [`rhai_functions.js`](https://github.com/lupyuen2/blockly-bl602/blob/master/generators/rhai/rhai_functions.js#L40-L50)
...
This JavaScript function emits a __Rhai loop__ that wraps the code inside the __`forever`__ block like so...
...
And here's the __`digital write` Code Generator__: [`rhai_functions.js`](https://github.com/lupyuen2/blockly-bl602/blob/master/generators/rhai/rhai_functions.js#L81-L94)
