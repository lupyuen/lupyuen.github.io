...
Yep [__Pine64 Oz64 SBC__](https://pine64.org/documentation/Oz64/) is supported by NuttX Mainline! Just follow the exact same instructions we covered earlier...

## Download the Linux MicroSD

Download the Linux MicroSD created by [__Justin Hammond__](https://github.com/Fishwaldo) (Fishwaldo)...
...
- TODO: [__NuttX Image: Image-sg2000__](https://github.com/lupyuen2/wip-nuttx/releases/download/sg2000-1/Image-sg2000)

- [__Device Tree: cv181x_milkv_duos_sd.dtb__](https://github.com/lupyuen2/wip-nuttx/releases/download/sg2000-1/cv181x_milkv_duos_sd.dtb)

When Oz64 boots, press Enter to reveal the __U-Boot Command Prompt__. Enter these commands to __Auto-Boot NuttX__ on Oz64...
...
Sophgo SG2000 SoC and Milk-V Duo S SBC are now officially supported by __Apache NuttX Mainline__! 🎉
