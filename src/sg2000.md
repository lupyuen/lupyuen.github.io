...
_How will NuttX print something to the Serial Console?_

According to the [__SG2000 Reference Manual__](https://github.com/sophgo/sophgo-doc/releases): The __UART Controller__ is at these Base Addresses...
...
1.  And fixed the [__NuttX Driver__](TODO) for PLIC Interrupts: [arch/risc-v/src/bl808/hardware/bl808_memorymap.h](https://github.com/lupyuen2/wip-nuttx/commit/f5f1aeac36350b8149fc2a77c817217711f082f6#diff-8fffa570a48f8f10004d9da8d4c671d34336f6c4b8dcfc2bd72275d8cda4ac04)
...
# Appendix: Set the NuttX Memory Map for SG2000
...
# Appendix: Disable the PLIC Interrupt Controller
...
# Appendix: Select the NuttX Driver for 16550 UART
...
# Appendix: Enable Logging for NuttX Scheduler and Binary Loader
...
# Appendix: NuttX Crash Dump on SG2000
...
# Appendix: Dump the SG2000 Linux Device Tree
...
We copy out the SG2000 Device Tree Binary: [cv181x_milkv_duos_sd.dtb](https://github.com/lupyuen/nuttx-sg2000/blob/main/cv181x_milkv_duos_sd.dtb)

And convert it to Device Tree Source: [cv181x_milkv_duos_sd.dts](https://github.com/lupyuen/nuttx-sg2000/blob/main/cv181x_milkv_duos_sd.dts)
...
# Appendix: Interrupt Controller for SG2000

TODO

We dumped the SG2000 Linux Device Tree. Let's extract the Interrupt Controller to understand it.

Based on the SG2000 Device Tree: [cv181x_milkv_duos_sd.dts](https://github.com/lupyuen/nuttx-sg2000/blob/main/cv181x_milkv_duos_sd.dts)
...
# Appendix: Fix the NuttX Driver for PLIC
