...
And the __Ethernet Driver__ is fully operational in U-Boot. Which means we can boot __NuttX over the Network__ (TFTP)...
...
See "__`123`__"? That's evidence that our NuttX Boot Code __is actually running__ on SG2000 and Milk-V Duo S! We port some more...

[(See the __Complete Log__)](https://gist.github.com/lupyuen/78b54326daf0894a2c23ab6d2c03456d)

![TODO](https://lupyuen.github.io/images/sg2000-kernel.png)
...
After applying the above fixes: __NuttX Kernel__ boots successfully!
...
![TODO](https://lupyuen.github.io/images/sg2000-nsh.png)
...
After fixing the Interrupt Controller and UART Interrupts: NuttX Kernel boots all the way to __NuttX Shell__!
...
[__NuttX OSTest__](TODO) is the perfect way to test everything in NuttX...
...
![TODO](https://lupyuen.github.io/images/sg2000-box.jpg)
...
TODO: https://github.com/lupyuen2/wip-nuttx/releases/tag/sg2000-1
...
TODO: Fix the UART Clock: _16550_UART0_CLOCK_
