...
We ran a script to __Upload the Test Logs__ into the GitHub Release Notes: [upload.sh](https://github.com/lupyuen2/autotest-nuttx-sg2000/blob/main/scripts/upload.sh)
