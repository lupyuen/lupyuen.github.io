...
Yep we'll boot the NuttX Image that's copied to our [__TFTP Server__](https://lupyuen.github.io/articles/sg2000#boot-nuttx-over-tftp).

This requires a [__MicroSD Card with U-Boot Bootloader__](https://lupyuen.github.io/articles/sg2000#download-the-linux-microsd). And some special [__U-Boot Commands for TFTP__](https://lupyuen.github.io/articles/sg2000#boot-nuttx-over-tftp).

(That will run automatically because of __`saveenv`__)

See __nuttx.exp__ from above? Let's talk about the Automated Test Script...
...
__OSTest__ will run a whole bunch of NuttX Tests, exercising everything thoroughly and vetting our fitness.

TODO: Pic of Test Log
...
We ran a script to __Upload the Test Log__ into the GitHub Release Notes: [upload.sh](https://github.com/lupyuen2/autotest-nuttx-sg2000/blob/main/scripts/upload.sh)
...
Actually we run the scripts [__every 10 minutes__](https://github.com/lupyuen2/autotest-nuttx-sg2000/blob/main/scripts/task.sh#L54-L66), waiting for the latest Daily Build.
