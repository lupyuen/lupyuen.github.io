...
Earlier this year we created a RISC-V Emulator for __Ox64 BL808 SBC__. We built it by customising __TinyEMU RISC-V Emulator__ (not the small flightless bird)...
...
Can we create a RISC-V Emulator for [__Sophgo SG2000 SoC__](TODO)? So we can test [__Apache NuttX RTOS__](TODO) every day on our emulated [__Pine64 Oz64 SBC__](TODO) (pic above) and [__Milk-V Duo S__](TODO)?
...
wget $repo/releases/download/nuttx-sg2000-$date/Image
wget $repo/releases/download/nuttx-sg2000-$date/nuttx.hash
...
__QEMU Emulator__ is way to complex to customise for SG2000. Instead we're running QEMU Emulator for [__Daily Testing of NuttX QEMU__](https://github.com/lupyuen/nuttx-riscv64/actions/workflows/qemu-riscv-nsh64.yml).
